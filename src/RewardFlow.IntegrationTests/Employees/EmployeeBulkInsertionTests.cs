...
public class EmployeeBulkInsertionTests : IAsyncLifetime
{
    private readonly TestWebApplicationFactory _factory;
    private readonly DbUtility _dbUtility;
    private UserClient _userClient;

    public EmployeeBulkInsertionTests(EmployeeTestFixture factory)
    {
        _factory = factory;
    ...
    public async Task BulkInsertEmployees_WithDuplicateNationalNumbers_ShouldReturnBadRequest()
    {
        ...
        var existingEmployee = TestDataGenerator.Employee
            ...
            .Generate();
        var request = CreateEmployeeRequest(existingEmployee);
